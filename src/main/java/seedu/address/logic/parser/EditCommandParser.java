...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        if (argMultimap.getValue(PREFIX_OWNER_NAME).isPresent()) {
            editPersonDescriptor.setName(ParserUtil.parseName(argMultimap.getValue(PREFIX_OWNER_NAME).get()));
        }
    ...
    /**
     * Returns true if all specified prefixes contain non-empty values in the given {@code ArgumentMultimap}.
     */
